    ...
    protected function process_bulk_action() {
		...
		if ( 'delete' === $this->current_action() ) { 
            ...
            if(wp_verify_nonce( $nonce, 'bulk-' . $this->_args['plural'] ) ) {
                ...
                $bulk_request = isset($_REQUEST['cwp_tax_fields_bulk_action']) ? CubeWp_Sanitize_text_Array($_REQUEST['cwp_tax_fields_bulk_action']) : array(); //phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized, WordPress.Security.ValidatedSanitizedInput.MissingUnslash
