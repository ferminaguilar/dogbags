...
class CubeWp_Tag_Password extends \Elementor\Core\DynamicTags\Tag
{

	public function get_name()
	{
		return 'cubewp-password-tag';
	}

	public function get_title()
	{
		return esc_html__('Fields type (password)', 'cubewp-framework');
	}
	...
	protected function register_controls()
	{
		...
		$options = get_fields_by_type(array('password'));
		...
		$user_field_options = get_user_fields_by_type(array('password'));
