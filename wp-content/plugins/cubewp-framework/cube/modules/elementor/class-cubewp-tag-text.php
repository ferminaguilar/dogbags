...
class CubeWp_Tag_Text extends \Elementor\Core\DynamicTags\Tag
{

	public function get_name()
	{
		return 'cubewp-text-tag';
	}

	public function get_title()
	{
		return esc_html__('Fields type (text)', 'cubewp-framework');
	}
	...
	protected function register_controls()
	{
		...
		$options = get_fields_by_type(array('text'));
		...
		$user_field_options = get_user_fields_by_type(array('text'));
