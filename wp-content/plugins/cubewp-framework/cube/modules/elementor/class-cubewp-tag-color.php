...
class CubeWp_Tag_Color extends \Elementor\Core\DynamicTags\Tag
{

	public function get_name()
	{
		return 'cubewp-color-tag';
	}

	public function get_title()
	{
		return esc_html__('Fields type (color)', 'cubewp-framework');
	}
	...
	protected function register_controls()
	{
		...
		$options = get_fields_by_type(array('color'));
		...
		$user_field_options = get_user_fields_by_type(array('color'));
