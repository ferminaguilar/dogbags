...
class CubeWp_Tag_Time_Picker extends \Elementor\Core\DynamicTags\Tag
{

	public function get_name()
	{
		return 'cubewp-time_picker-tag';
	}

	public function get_title()
	{
		return esc_html__('Fields type (time_picker)', 'cubewp-framework');
	}
	...
	protected function register_controls()
	{
		...
		$options = get_fields_by_type(array('time_picker'));
		...
		$user_field_options = get_user_fields_by_type(array('time_picker'));
