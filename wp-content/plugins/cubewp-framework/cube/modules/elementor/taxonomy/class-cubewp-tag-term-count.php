...
class CubeWp_Tag_Term_count extends Tag {

	public function get_name() {
		return 'cubewp-term-count-tag';
	}

	public function get_title() {
		return esc_html__( 'Term Count', 'cubewp-framework' );
	}
	...
	public function render() {
		...
		$term_count = isset( $cubewp_term->count ) ? $cubewp_term->count : 0;
		echo esc_html( $term_count );
	}
