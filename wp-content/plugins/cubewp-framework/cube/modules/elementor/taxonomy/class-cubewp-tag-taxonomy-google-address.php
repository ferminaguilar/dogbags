...
class CubeWp_Tag_Taxonomy_google_address extends Tag {

	public function get_name() {
		return 'cubewp-taxonomy-google-address-tag';
	}

	public function get_title() {
		return esc_html__( 'Taxonomy Google Address', 'cubewp-framework' );
	}
	...
	protected function register_controls() {
		...
		if ( function_exists( 'cubewp_get_taxonomy_fields_by_type' ) ) {
			$options = cubewp_get_taxonomy_fields_by_type( array( 'google_address' ) );
		}
