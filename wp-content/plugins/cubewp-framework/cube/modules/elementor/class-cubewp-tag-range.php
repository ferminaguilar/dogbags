...
class CubeWp_Tag_Range extends \Elementor\Core\DynamicTags\Tag
{

	public function get_name()
	{
		return 'cubewp-range-tag';
	}

	public function get_title()
	{
		return esc_html__('Fields type (range)', 'cubewp-framework');
	}
	...
	protected function register_controls()
	{
		...
		$options = get_fields_by_type(array('range'));
		...
		$user_field_options = get_user_fields_by_type(array('range'));
