...
class CubeWp_Tag_Date_Picker extends \Elementor\Core\DynamicTags\Tag
{

	public function get_name()
	{
		return 'cubewp-date_picker-tag';
	}

	public function get_title()
	{
		return esc_html__('Fields type (date_picker)', 'cubewp-framework');
	}
	...
	protected function register_controls()
	{
		...
		$options = get_fields_by_type(array('date_picker'));
		...
		$user_field_options = get_user_fields_by_type(array('date_picker'));
