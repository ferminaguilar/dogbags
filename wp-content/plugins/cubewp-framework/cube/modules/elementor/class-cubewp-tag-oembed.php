...
class CubeWp_Tag_Oembed extends \Elementor\Core\DynamicTags\Tag
{

	public function get_name()
	{
		return 'cubewp-oembed-tag';
	}

	public function get_title()
	{
		return esc_html__('Fields type (oembed)', 'cubewp-framework');
	}
	...
	protected function register_controls()
	{
		...
		$options = get_fields_by_type(array('oembed'));
		...
		$user_field_options = get_user_fields_by_type(array('oembed'));
