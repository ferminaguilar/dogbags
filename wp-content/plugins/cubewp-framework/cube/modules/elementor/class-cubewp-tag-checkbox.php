...
class CubeWp_Tag_Checkbox extends \Elementor\Core\DynamicTags\Tag
{

	public function get_name()
	{
		return 'cubewp-checkbox-tag';
	}

	public function get_title()
	{
		return esc_html__('Fields type (checkbox)', 'cubewp-framework');
	}
	...
	protected function register_controls()
	{
		...
		$options = get_fields_by_type(array('checkbox'));
		...
		$user_field_options = get_user_fields_by_type(array('checkbox'));
