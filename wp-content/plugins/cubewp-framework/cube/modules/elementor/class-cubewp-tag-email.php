...
class CubeWp_Tag_Email extends \Elementor\Core\DynamicTags\Tag
{

	public function get_name()
	{
		return 'cubewp-email-tag';
	}

	public function get_title()
	{
		return esc_html__('Fields type (email)', 'cubewp-framework');
	}
	...
	protected function register_controls()
	{
		...
		$options = get_fields_by_type(array('email'));
		...
		$user_field_options = get_user_fields_by_type(array('email'));
