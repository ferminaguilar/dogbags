...
class CubeWp_Tag_Dropdown extends \Elementor\Core\DynamicTags\Tag
{

	public function get_name()
	{
		return 'cubewp-dropdown-tag';
	}

	public function get_title()
	{
		return esc_html__('Fields type (dropdown)', 'cubewp-framework');
	}
	...
	protected function register_controls()
	{
		...
		$user_field_options = get_user_fields_by_type(array('dropdown'));
