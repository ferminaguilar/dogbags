...
/**
 * CubeWp_Frontend_Time_Picker_Field
 */
class CubeWp_Frontend_Time_Picker_Field extends CubeWp_Frontend {
    
    public function __construct( ) {
        add_filter('cubewp/frontend/time_picker/field', array($this, 'render_time_picker_field'), 10, 2);
        
        add_filter('cubewp/user/registration/time_picker/field', array($this, 'render_time_picker_field'), 10, 2);
        add_filter('cubewp/user/profile/time_picker/field', array($this, 'render_time_picker_field'), 10, 2);
...
new CubeWp_Frontend_Time_Picker_Field();