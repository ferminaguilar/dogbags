...
/**
 * CubeWp_Admin_Image_Field
 */
class CubeWp_Admin_Image_Field extends CubeWp_Admin {
    
    public function __construct( ) {
        add_filter('cubewp/admin/post/image/field', array($this, 'render_image_field'), 10, 2);
    }
        
    /**
     * Method render_image_field
     *
     * @param string $output
     * @param array $args
     *
     ...
     * @since  1.0.0
     */
    public function render_image_field( $output = '', $args = array() ) {
        ...
        if (isset($args["file_types"]) && !empty($args["file_types"])) {
            ...
            $accept = esc_html__("image/png, image/jpg, image/jpeg, image/gif", 'cubewp-framework');
        }
		...
		$output .= '<div class="cwp-custom-field cwp-upload-field">
            <div class="cwp-field">
                ...
                <a href="javascript:void(0);" class="button cwp-image-upload-button" data-allowed-types="' . $accept_types . '">' . esc_html__('Insert image', 'cubewp-framework') . '</a>
