<?php
/**
 * CubeWp admin date and time picker field 
 *
 * @version 1.0
...
/**
 * CubeWp_Admin_Date_Time_Picker_Field
 */
class CubeWp_Admin_Date_Time_Picker_Field extends CubeWp_Admin {
    
    public function __construct( ) {
        add_filter('cubewp/admin/post/date_time_picker/field', array($this, 'render_date_time_picker_field'), 10, 2);
    }
...
if ( ! empty( $args['value'] ) && is_numeric( $args['value'] ) ) {
        ...
        $output = $this->cwp_field_wrap_start($args);
            $output .= '<div class="cwp-date-time-picker">';
...
new CubeWp_Admin_Date_Time_Picker_Field();