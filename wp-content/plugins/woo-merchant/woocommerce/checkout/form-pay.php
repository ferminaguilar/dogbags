	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'woomen' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'woomen' ); ?></th>
			</tr>
		</thead>
		<tbody>
		...
		<tfoot>
			<?php if ( $totals ) : ?>
				<?php foreach ( $totals as $total ) : ?>
					<tr>
						<th scope="row" colspan="2"><?php esc_html( $total['label'] ); ?></th><?php // @codingStandardsIgnoreLine ?>
