...
(function( $ ) {
    ...
    $.cubewp_user_register.submit_form = function( t ) {
        ...
        var is_valid = cubewp_frontend_form_validation( jQuery(t).closest('.cwp-user-register'));
        
        if( is_valid == true ){
            var formData = new FormData( jQuery(t).closest('.cwp-user-register')[0]);
             jQuery(t).closest('.cwp-user-register').find(".cwp-field-wysiwyg_editor").each(function() {
            ...
            formData.append('action', 'vp_submit_user_register');
