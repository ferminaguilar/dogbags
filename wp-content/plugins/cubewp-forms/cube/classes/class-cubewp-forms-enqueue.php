...
class CubeWp_Forms_Enqueue {
	...
	public static function register_admin_styles( $styles ) {
		$register_styles = array(
			...
			'cubewp-admin-templates' => array(
				'src'     => CWP_FORMS_PLUGIN_URL . 'cube/assets/css/cubewp-admin-templates.css',
				'deps'    => array(),
				'version' => CUBEWP_FORMS_VERSION,
				'has_rtl' => false,
			),
	...
	public static function register_admin_scripts( $script ) {
		$register_scripts = array(
			'cubewp-forms-admin' => array(
				'src'     => CWP_FORMS_PLUGIN_URL . 'cube/assets/js/cubewp-forms-admin.js',
				'deps'    => array( 'jquery' ),
				'version' => CUBEWP_FORMS_VERSION,
			),
		);
