jQuery(document).ready(function () {
    ...
    jQuery(document).on('submit', 'form.cwp-user-form-submit.cwp-custom-form', function (e) {
        ...
        if (is_valid == true) {
            ...
            $form.find(".cwp-field-wysiwyg_editor").each(function () {
            ...
            jQuery.ajax({
                ...
                success: function (response) {
                    ...
                    if (typeof response.redirectURL != 'undefined' && response.redirectURL != '') {
                        ...
                        // Reset the form fields and WYSIWYG editors after successful submission
                        $form[0].reset();
                        $form.find('.cwp-field-wysiwyg_editor').each(function () {
                            var editor_id = jQuery(this).data('id');
                            ...
                            jQuery('textarea#' + editor_id).val('');
                        });
                        // Remove animated borders if any
                        $form.find('.cwp-field-container').removeClass('animated-border-bottom');
                    }
                }
            });
